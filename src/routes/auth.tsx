...
export const Route = createFileRoute("/auth")({
  ...
  head: () => ({
    meta: [
      { title: "Masuk Portal Kandidat — PT. Dover Chemical" },
      {
        name: "description",
        content:
          "Masuk atau buat akun kandidat PT. Dover Chemical untuk mengisi dan mengunduh formulir lamaran.",
      },
      { property: "og:title", content: "Masuk Portal Kandidat — PT. Dover Chemical" },
      {
        property: "og:description",
        content: "Login kandidat untuk mengisi formulir lamaran PT. Dover Chemical.",
      },
    ],
  }),
  component: AuthPage,
